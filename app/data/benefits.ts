...
export const benefits: Benefit[] = [
  {
    ...
    howTo: "Head to the ADDU Health Services Unit with your valid student ID. Schedule an appointment at the clinic during operating hours.",
    emoji: "🦷",
    color: "#E8F4FD",
    accentColor: "#2196F3",
    textColor: "#0D47A1",
  ...
  },
  {
    ...
    howTo: "Go to canva.com/education and sign up or log in with your ADDU student email. Verify your student status to unlock Pro features instantly.",
    emoji: "🎨",
    color: "#FCE4EC",
    accentColor: "#E91E63",
    textColor: "#880E4F",
